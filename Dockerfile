...
# docker build -t kzlt_ruby .
# docker run -d -p 80:3000 -e RAILS_MASTER_KEY=<value from config/master.key> --name kzlt_ruby kzlt_ruby
...
EXPOSE 3000
CMD ["./bin/prd-entrypoint", "./bin/rails", "server"]
